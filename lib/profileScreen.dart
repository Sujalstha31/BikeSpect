            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  bikeObj.updateData(selectedDoc, bikeData).then((value) {
  ...
  getResults() {
    FirebaseFirestore.instance
      ...
      setState(() {
        ...
        userNumber = bikes.docs[0]['userNumber'];
        adUserImageUrl = bikes.docs[0]['imgPro'];
      });
                  ...
                  trailing: bikes.docs[i]['uId'] == userId
                      ? Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                if (bikes.docs[i]['uId'] == userId) {
                                  showDialogForUpdateData(bikes.docs[i].id);
                                }
                              },
                              child: Icon(
                                Icons.edit_outlined,
                            ...
                            GestureDetector(
                                onDoubleTap: () {
                                  if (bikes.docs[i]['uId'] == userId) {
                                    bikeObj.deleteData(bikes.docs[i].id);
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
